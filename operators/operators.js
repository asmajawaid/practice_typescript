...
//Binary operator 
let a1 = 1, b1 = 2;
let c1 = a1 + b1; // + is a binary operator
console.log(c1); // 3
// Ternary operator
// let aa: number = 5
...
let apple = 10;
let appleEat = 5;
let fridge = apple + appleEat;
console.log(fridge);
//SUBTR
let banana = 10;
let bananaEat = 5;
let onTable = banana - bananaEat;
console.log(onTable);
//MULTI
let kiwi = 10;
let kiwiEat = 5;
let cart = kiwi * kiwiEat;
console.log(cart);
// DIVISIO
let mango = 10;
let mangoEat = 5;
let Bowl = kiwi / kiwiEat;
console.log(Bowl);
//EXPONENT 
let MoneyPlant = 10;
let GrowPlant = 10;
let totalBabyPlant = MoneyPlant ** 2;
console.log(totalBabyPlant);
// MODULUS
let apples = 15;
let applesEat = 2;
let Topfridge = apples % applesEat;
