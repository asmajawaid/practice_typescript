...
function sum9 (num1:number, num2:number){ 
...
// ===============================================================================
                                  //ARROW FUNCTION
 let fryEgg2 = ()=> 1+1.5+2;
 let action2:number = fryEgg2()        
 console.log(action2)
// ======================================
let fryEgg = (egg:number,butter:number,salt:number):number=> (egg+butter+salt)
let actions:number = fryEgg(1,1.5,5)        
console.log(actions)
// ===============================================
let fryEgg1 = ():number=> {return 1+1.5+5}
let action1:number = fryEgg1()        
console.log(action1)
// =============================================================
// let sumArrow = ()=>{
// let num1:number=10;
...
//     sumArrow(10,20); //or hum input bhi de sakty he
 ...
 let samResult:number =  sumArrow(10,20)-25; // ab return k sath hum extra operation krskty he
...
let sumarrow =(num3:number, num4:number):number=>num3+num4
let calculation:number=sumarrow(50,80)
...
// console.log(response)
// ==========================REST PARAMETER====================================
function halfFryEggs(egg:number=1, ...ingrediants:number[]){
             console.log(egg)
             console.log(ingrediants)
}
halfFryEggs(1,1.5,2,5)
// ==============================================
function halfFryEgg0(egg:number=1, ...ingrediants:number[]){
    console.log(egg)
    console.log(...ingrediants)
}
console.log("rest");
